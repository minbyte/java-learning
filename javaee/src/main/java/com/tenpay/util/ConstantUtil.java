...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx135e02055f2c9dac";//微信开发平台应用id
	public static String APP_SECRET = "71d5ccba75db1daa627d905cc601bd06";//应用对应的凭证
	public static String APP_KEY = "47f73b5eef94afd27f39f7f87d3a00a5"; //应用对应的密钥
	public static String PARTNER = "1220017601";  //财付通商户号
	public static String PARTNER_KEY = "z9yla32ef9i5ekr9771wlrsmmuwmawb4";//商户号对应的密钥
